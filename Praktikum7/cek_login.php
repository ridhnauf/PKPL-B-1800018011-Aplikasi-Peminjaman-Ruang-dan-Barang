...
// cek apakah captcha_code sesuai yang di isi sesuai dengan captcha_code yang diberikan oleh SESSION
if ($_POST["captcha_code"] == $_SESSION["captcha_code"]) {
    ...
    mysqli_close($con);
    // jika captcha tidak sesuai maka jalankan program dibawah ini
} else {
